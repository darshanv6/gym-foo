...
class DoubleDQN:
    def __init__(self,agent_name=None,env=gym.make('HotterColder-v0'),number_episodes = 500,discounting_factor = 0.9,learning_rate=0.001,behaviour_policy = "epsilon_decay",policy_parameters={"epsilon":1.0,"min_epsilon":0.01,"epsilon_decay_rate":0.99},deep_learning_model_hidden_layer_configuration = [32,16,8]):
